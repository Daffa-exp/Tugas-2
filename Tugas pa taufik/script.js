...
function saveTasks() {
    ...
    document,querySelectorAll("#list-container li").forEach(li => {
        tasks.push({
            text: li.querySelectorAll(".task-text").innerText,
            completed: li.classList.contains("completed"),
            category: li.dataset.category,
            color: li.style.bacgroundColor
        });
    });
...
function loadTasks() {
    ...
    tasks.forEach(tasks => addTask(tasks.text, tasks.completed, tasks.color, tasks.category, false));
    updateCounter();
}
...
function addTask(taskText = null, completed = false, taskColor = null, taskCategory = null, save = true) {
    ...
    li.style.bacgroundColor = taskColor;
...
function filterTasks() {
    ...
    document.querySelectorAll(".taks-item").forEach(li => {
...
function updateCounter() {
    const totalTaks = document.querySelectorAll(".taks-item").length;
    const completedTaks = document.querySelectorAll(".taks-item.completed").length;
    const uncompletedTaks = totalTaks - completedTaks;

    completedCounter.innerText = completedTaks;
    uncompletedCounter.innerText = uncompletedTaks;
}
